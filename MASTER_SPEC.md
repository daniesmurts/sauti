...
This document is the single source of truth for the entire project. Before starting any Claude Code session, paste the relevant section as context. Use this pattern:

```
Read the following spec section carefully before writing any code.
Do not deviate from the stack decisions or architecture in section 3.
[paste relevant section]

Task: [your specific task]
```

For new features, always reference the module spec in section 6.
For backend work, always reference the API contracts in section 7.
For security-sensitive code, always reference section 8 before starting.
...
|---|---|---|---|
| Framework | React Native (bare) | 0.74.x | Stable LTS branch |
...
| Animations | Reanimated 3 | latest | Native thread animations |
